...
export const S = {
  ...
  layoutToggle: { display: "flex", gap: 3, background: PANEL, border: `1px solid ${LINE}`, borderRadius: 9, padding: 3 },
  layoutBtn: { font: "inherit", fontSize: 12, fontWeight: 600, color: MUTED, background: "none", border: "none", padding: "5px 11px", borderRadius: 6, cursor: "pointer", whiteSpace: "nowrap" },
  layoutBtnOn: { background: PANEL2, color: INK },
